...
import { KeyedTokensInfo, MagicMoveDifferOptions, MatchedRanges } from './types.js';
export { KeyedToken, MagicMoveRenderOptions, Range } from './types.js';
import 'diff-match-patch-es';

type ArgumentsType<F extends Function> = F extends (...args: infer A) => any ? A : never;
declare function createMagicMoveMachine(codeToKeyedTokens: (code: string) => KeyedTokensInfo, options?: MagicMoveDifferOptions): {
...
declare function codeToKeyedTokens<BundledLangKeys extends string, BundledThemeKeys extends string>(highlighter: HighlighterGeneric<BundledLangKeys, BundledThemeKeys>, code: string, options: ArgumentsType<HighlighterGeneric<BundledLangKeys, BundledThemeKeys>['codeToTokens']>[1]): KeyedTokensInfo;
declare function toKeyedTokens(code: string, tokens: ThemedToken[][], salt?: string): KeyedTokensInfo;
/**
